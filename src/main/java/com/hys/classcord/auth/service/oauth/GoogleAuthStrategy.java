...
public class GoogleAuthStrategy implements OAuth2Strategy {
    ...
    public GoogleAuthStrategy(@Value("${spring.security.oauth2.client.registration.google.client-id}") String googleClientId) {
